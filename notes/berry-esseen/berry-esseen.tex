...
its variation function  $V_G$ is continuous and the functions $V_G-G$ and $V_G$ are nondecreasing,\footnote{\url{http://individual.utoronto.ca/jordanbell/notes/helly.pdf}, p.~6, Theorem 8 and Theorem 9.} 
...
\end{lemma}
\begin{proof}
For $1 \leq j \leq k_n$ and $l \geq 0$ and $v \in \mathbb{R}$,\footnote{\url{http://individual.utoronto.ca/jordanbell/notes/lindeberg.pdf},
p.~1, Theorem 1.}
\[
...
Ivan Nourdin and Giovanni Peccati, {\em Normal Approximations with Malliavin Calculus:
From SteinÕs Method to Universality}, p.~71, Theorem 3.7.1.}
