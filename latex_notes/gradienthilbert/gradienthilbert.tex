...
$f':U \to \mathscr{L}(X;\mathbb{R})=X^*$.\footnote{See \url{http://individual.utoronto.ca/jordanbell/notes/weaksymplectic.pdf},
\S 3; \url{http://individual.utoronto.ca/jordanbell/notes/frechetderivatives.pdf}}
...
of holomorphic functions on the open unit disc, which is what Montel's theorem says: \url{http://individual.utoronto.ca/jordanbell/notes/holomorphic.pdf}, Theorem 13.}
...
p.~480, Theorem 2;
Antonio Ambrosetti and David Arcoya çlvarez, {\em An Introduction to Nonlinear Functional Analysis and Elliptic Problems},
p.~48, \S 5.3.}
